...
// */
//public class ActivityPicker_bak extends Activity implements View.OnClickListener,
...
////        this.mRecyclerView.addItemDecoration(new ItemDecorationGrid(0xFFFF0000, dp5));
...
//            e.printStackTrace();
//            Toast.makeText(ActivityPicker_bak.this, "没有拍照应用", Toast.LENGTH_SHORT).show();
//        } catch (Exception e) {
//            Toast.makeText(ActivityPicker_bak.this, "拍照失败", Toast.LENGTH_SHORT).show();
//        }
//    }
//
...
//        } catch (ActivityNotFoundException e) {
//            e.printStackTrace();
//            Toast.makeText(ActivityPicker_bak.this, "没有录像应用", Toast.LENGTH_SHORT).show();
//        } catch (Exception e) {
//            Toast.makeText(ActivityPicker_bak.this, "录制失败", Toast.LENGTH_SHORT).show();
//        }
//    }
//
//    @Override
